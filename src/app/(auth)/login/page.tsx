    ...
    <div className="flex items-center justify-center min-h-screen bg-gray-50">
      <div className="w-full max-w-md p-8 my-4 bg-white rounded-lg shadow-lg">
        <div className="flex justify-center mb-4">
          <img
            src="_next/image?url=%2Ffresh-track-logo-fill.png&w=32&q=75"
            alt="Fresh"
            className="w-14 h-14"
          />
        </div>
        ...
        <form className="space-y-4" onSubmit={handleSubmit}>
          <div>
            <label htmlFor="username" className="block font-medium mt-5">
              Username
            </label>
            <input
              id="username"
          ...
          <div>
            <label htmlFor="password" className="block font-medium mt-5">
              Password
            </label>
            <input
              id="password"
          ...
          <div className="flex items-center">
            ...
            />
            <Label htmlFor="remember" className="ml-2 items-">
              Remember me
            </Label>
          </div>
